...
//        clea("//label[text()='Employee Full Name']/../following-sibling::div//input[@name='lastName']");
        ...
        getSelect("//label[text()='Nationality']/../following::div//div[@class='oxd-select-text oxd-select-text--active']",2);
        getSelect("//label[text()='Marital Status']/../following::div//div[@class='oxd-select-text oxd-select-text--active']",0);
        getdaTe("//label[text()='Date of Birth']/../following-sibling::div//input[@class='oxd-input oxd-input--active']");
        getRadio("//label[text()='Gender']/../following-sibling::div//div[@class='oxd-radio-wrapper']//input[@type='radio' and @value ='2']");
        getTex("//label[text()='Military Service']/../following-sibling::div//input[@class='oxd-input oxd-input--active']","1");
        getTex("//label[text()='Smoker']","no");
    ...
    public static void getSelect(String xpath, int num) {
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)));
        WebElement element = driver.findElement(By.xpath(xpath));
        wait.until(ExpectedConditions.elementToBeClickable(element));
